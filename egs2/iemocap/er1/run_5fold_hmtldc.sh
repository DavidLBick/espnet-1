...
CUDA_VISIBLE_DEVICES=${cuda_device} ./er.sh \
    ...
    --er_tag conformer_discrete_continuous_hmtldc_hubertlarge_fold${nj} \
    --er_args "--wandb_project multilabel-emorec --wandb_entity cmu-mlsp-emo --use_wandb true --wandb_name conformer_discrete_continuous_hmtldc_hubertlarge_fold${nj}" \
    --er_config "${er_config}" \
